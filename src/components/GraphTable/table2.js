                    ...
                    <tbody>
                      ...
                      {this.props.resdata.map ? this.props.resdata.map(
                          (m, v) => {
                            ...
                            const getData = () => {
                              const url = 'https://min-api.cryptocompare.com/data/histoday?fsym=BTC&tsym=USD&limit=30&aggregate=1&e=CCCAGG';
                            ...
                            return <tr key={v}>
                                <td className="td-border">
                                  {/* {console.log('asdasdasd', this.sortedData)} */}
                                  {m.rank}
                                </td>
                                <td style={{ width: "15%" }}>
...
const mapDispatchToProps = (dispatch) => {
    return ({
        getdataa : () => {dispatch(MiddleWare.GetData2()); }
    })
}
