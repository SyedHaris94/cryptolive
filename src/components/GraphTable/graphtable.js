                      ...
                      {this.props.resdata.map ? this.props.resdata.map(
                          (m, v) => {
                            return <tr key={v}>
                                ...
                                <td style={{ width: "15%" }}>
                                  <Link to={gotoUrl(m.id)} onClick={window.scrollTo(0, 0)} style={{ textDecoration: "none" }}>
                                ...
                                <td>
                                  {/*<img src={"https://chart.googleapis.com/chart?&cht=ls&chd=t:0,15,35,42,25,6937,8218&chco=ff0000&chs=250x150"} />*/}
                                  <LineChart width={100} height={50} data={data}>
                                    <Line type="monotone" dataKey="pv" stroke="#C92E8C" strokeWidth={2} />
                                  </LineChart>
                                  {m.percent_change_7d}%
